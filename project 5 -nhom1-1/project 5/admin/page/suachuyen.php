...
if($id <= 0){
    ...
    if(empty($error)){
        $data = array(
            ...
            $stmt = $conn->prepare("UPDATE `chuyenxe` SET Giodi = :Giodi,Gioden = :Gioden,Diemdi = :Diemdi,Diemden = :Diemden,Giave = :Giave,Chotrong = :Chotrong,id_lotrinh = :id_lotrinh,id_taixe = :id_taixe,id_xe = :id_xe WHERE id = :id");
