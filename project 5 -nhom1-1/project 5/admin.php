        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="selected">
                        <a href="admin.php?p=trangchu"><i class="fa fa-dashboard fa-fw"></i> Trang Chủ</a>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level" align="center">
                            <li >
                                 <a href="admin.php?p=themlotrinh">Thêm Lộ Trình</a>                       
                            </li>
                            <li>
                                <a href="admin.php?p=danhsachlotrinh">Danh Sách Lộ Trình</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level" align="center">
                            <li>
                                <a href="admin.php?p=themchuyen">Thêm Chuyến</a>
                            </li>
                            <li>
                                <a href="admin.php?p=danhsachchuyen">Danh Sách Chuyến</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level" align="center">
                            <li>
                                <a href="admin.php?p=themxe">Thêm Xe</a>
                            </li>
                            <li>
                                <a href="admin.php?p=danhsachxe">Danh Sách Xe</a>
                            </li>
                     ...
                     <li>
                        ...
                        <ul class="nav nav-second-level" align="center">
                            <li>
                                <a href="admin.php?p=themtaixe">Thêm Tài Xế</a>
                            </li>
                            <li>
                                <a href="admin.php?p=danhsachtaixe">Danh Sách Tài Xế</a>
                            </li>
                            <li>
                                <a href="admin.php?p=danhsachvitritaixe">Danh Sách Vị Trí Tài Xế</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level" align="center">
                            <li>
                                <a href="admin.php?p=themthanhvien">Thêm Thành Viên</a>
                            </li>
                            <li>
                                <a href="admin.php?p=danhsachthanhvien">Danh Sách Thành Viên</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level" align="center">
                            ...
                            <li>
                                <a href="admin.php?p=danhsachdonhang">Danh Sách Đơn Hàng</a>
                            </li>
                     ...
                     <li>
                        ...
                        <ul class="nav nav-second-level" align="center">
                            <li>
                                <a href="admin.php?p=themve">Thêm Vé</a>
                            </li>
                            <li>
                                <a href="admin.php?p=danhsachve">Danh Sách Vé</a>
                            </li>
    ...
    if(isset($_GET["p"])){
        ...
        switch ($p) {
            ...
            case 'danhsachdonhang':
                include "page/danhsachdonhang.php";
                break;    
