                                            ...
                                            <?php 
                                             ...
                                             ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $item["TenTX"]; ?></td>
                                                    <td><?php echo $item["SDT"]; ?></td>
                                                    <td><?php echo $item["id_PLTX"]; ?></td>
                                                    <td width="50px"><a href="admin.php?p=xoataixe&id=<?php echo $item["id"]?>">Xóa</a></td>
                                                    <td width="50px"><a href="admin.php?p=suataixe&id=<?php echo $item["id"]?>">Sửa</a></td>
