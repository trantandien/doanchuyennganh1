                                            ...
                                            <?php 
                                             ...
                                             ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo date_format(date_create($item["Ngayve"]),"d-m-Y"); ?></td>
                                                    ...
                                                    <td><?php echo $item["id_vexe"]; ?></td>
                                                    <td width="50px"><a href="admin.php?p=xoachuyen&id=<?php echo $item["id"]?>">Xóa</a></td>
                                                    <td width="50px"><a href="admin.php?p=suachuyen&id=<?php echo $item["id"]?>">Sửa</a></td>
