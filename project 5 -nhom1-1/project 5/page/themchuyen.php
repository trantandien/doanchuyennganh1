...
if(isset($_POST["btnThem"])){
    ...
    if(empty($error)){
        $data = array(
            ...
            $stmt = $conn->prepare("INSERT INTO `chuyenxe`(`Giodi`, `Gioden`, `Diemdi`, `Diemden`,`Ngaydi`, `Ngayve`, `Giave`, `Chotrong`, `id_lotrinh`, `id_taixe`, `id_xe` , `id_vexe`) VALUES (:Giodi,:Gioden,:Diemdi,:Diemden,:Ngaydi, :Ngayve,:Giave,:Chotrong,:id_lotrinh,:id_taixe,:id_xe,:id_vexe)");
