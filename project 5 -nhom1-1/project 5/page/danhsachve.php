                                            ...
                                            <?php 
                                             ...
                                             ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $item["GiaveLB"]; ?></td>
                                                    <td><?php echo $item["Giodi"]; ?></td>
                                                    <td><?php echo $item["Ngaydi"]; ?></td>
                                                    <td><?php echo $item["Soghe"]; ?></td>
                                                    <td><?php echo $item["id_thanhvien"]; ?></td>
                                                    <td width="50px"><a href="admin.php?p=xoaxe&id=<?php echo $item["id"]?>">Xóa</a></td>
                                                    <td width="50px"><a href="admin.php?p=suave&id=<?php echo $item["id"]?>">Sửa</a></td>
